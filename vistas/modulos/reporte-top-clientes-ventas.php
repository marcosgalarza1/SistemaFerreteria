...
<div class="content-wrapper text-uppercase">
    ...
    <section class="content-header">
        <h1>REPORTE DE CLIENTES CON MAS VENTAS</h1>
        <ol class="breadcrumb">
            <li><a href="inicio"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li class="active">Top Ventas por clientes</li>
        </ol>
    </section>
            ...
            <div class="box-body">
                ...
                <div class="card card-secondary card-outline">
                    <div class="card-body">
                        ...
                        <img src="vistas/img/plantilla/reporte9.png" class="responsive-image" style="display: block; margin: 0 auto; max-width: 100%; height: auto; object-fit: contain;">
                    </div><!--/body card-->
                </div><!--/CARD FIN-->
...
<script>
    ...
    function generatePDF() {
        ...
        popupWindow = window.open(
            "extensiones/tcpdf/pdf/top-ventas-clientes.php?fechaInicio=" + encodeURIComponent(fechaInicio) +
