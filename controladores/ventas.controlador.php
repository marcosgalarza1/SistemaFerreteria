	...
	static public function ctrCrearVenta()
	{
		...
		if (isset($_POST["nuevaVenta"])) {
			...
			echo '<script>
				...
				swal({ 
					  type: "error",
					  title: "La venta no se ha ejecuta si no hay productos agreagados",
 ...
 */
	...
	/*=============================================
	rango de ventas top clñiente:
	=============================================*/
	static public function ctrRangoFechasVentasTopClientesPdf($fechaInicial, $fechaFinal)
	{

		$tabla = "ventas";

		$respuesta = ModeloVentas::mdlRangoFechasVentasTopClientesPdf($tabla, $fechaInicial, $fechaFinal);
